...
class SSVerifyCodeNumView: UIView {
    
    /// 光标颜色
    var cursorColor = UIColor(hexString: "#06A87A")
    ...
    override func layoutSubviews() {
        ...
        let path = UIBezierPath.init(rect: CGRect.init(x: self.frame.size.width * 0.5, y: self.frame.size.height * 0.45, width: 1, height: self.frame.size.height * 0.4))
